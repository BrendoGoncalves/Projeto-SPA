...
export function Menu(){
    ...
    return (<>
                ...
                <a className="underline-offset-2" href="https://spo.ifsp.edu.br/espaco-do-aluno"><Folder className="text-xl text-blue-400 w-10 h-10 focus:bg-blue-500" /></a>
                <a className="underline-offset-2" href="https://spo.ifsp.edu.br/espaco-do-aluno"><h2 className="text-xl">Vercel</h2></a>
                </div>
                ...
                <a className="underline-offset-2" href="https://spo.ifsp.edu.br/espaco-do-aluno"><GithubLogo className="text-xl text-blue-400 w-10 h-10 focus:bg-blue-500"/></a>
                <a className="underline-offset-2" href="https://spo.ifsp.edu.br/espaco-do-aluno"><h2 className="text-xl">GitHub</h2></a>
                </div>
                <div className="bg-purple-700 rounded large py-5 w-24 flex-1 flex flex-col items-center gap-2 border-2 border-transparent hover:border-blue-600 hover:bg-purple-600 focus:border-blue-900 focus:outline-none">
